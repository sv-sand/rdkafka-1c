...
ConfigBuilder::ConfigBuilder(Loger* Loger, ErrorHandler* Error, MessageStatusCollector* MessageStatusCollector)
{
    loger = Loger;
    error = Error;
    ...
    deliveryReport = new DeliveryReport(loger, MessageStatusCollector);
