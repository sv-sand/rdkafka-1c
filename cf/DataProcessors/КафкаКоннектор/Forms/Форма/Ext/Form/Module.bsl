...
Процедура ПрочитатьСообщения(Команда)
	...
	Если ЧитатьМетаданныеСообщений Тогда
		ПрочитатьСообщениеСМетаданнымиНаСервере();
	Иначе
...
&НаСервере
Процедура ПрочитатьСообщениеСМетаданнымиНаСервере()
	...
	Если МассивСообщений.Количество() <= 100 Тогда
		Для каждого Сообщение Из МассивСообщений Цикл
			...
			ТекстСообщения = "Сообщение: " + ЗаписьJSON.Закрыть();
...
Процедура ПрочитатьСообщениеНаСервере()
	...
	Пока МассивСообщений.Количество() < КоличествоСообщенийКЧтению
		И Коннектор.ПрочитатьСледующееСообщение() Цикл
